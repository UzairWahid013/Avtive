...
export default function AccessPopup({ handleModalClose }: { handleModalClose: () => void }) {
    ...
    return (
<div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center max-md:items-start max-md:pt-10 max-md:pb-6 overflow-y-auto">
<div className="w-[95%] md:w-[60%] md:max-w-[600px] bg-white rounded-2xl p-6 md:p-20 py-10 md:py-20 max-md:max-h-[90vh] max-md:overflow-y-auto">
<div
...
>
  <X className="w-6 h-6 md:w-8 md:h-8 cursor-pointer" />
                ...
                <GradientHeading heading="Early Access!" styles="text-2xl md:!text-5xl text-center !ml-0 mb-2" />
